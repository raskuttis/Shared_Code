...
dflist = ['UV_M5.0e4_R15.0_N128_Tf4_B50.0_LD_Test_SDs/', 'UV_M5.0e4_R15.0_N128_Tf4_B50.0_LD_Test_SDs/', 'UV_M5.0e4_R15.0_N128_Tf4_B50.0_LD_Test_SDs/']
dftlist = [0,0,0]
pdflist = ['sdmasspdfmeancirc.dat', 'sdmpdfxyplane.dat', 'sdmpdfyzplane.dat']
...
pp = PdfPages(plotdir + 'ft6-18.pdf')
pp.savefig()
pp.close()
