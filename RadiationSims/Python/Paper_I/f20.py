...
fitsigmalr = np.logspace(0.5, 3.5, num = 30.0)
fitepseff = []
nfs = len(fitsigmalr)
for i in xrange(0,nfs):
    sigma0 = fitsigmalr[i]
...
plt.plot(modelsigma,modeleffof,'r.',fitsigma,fiteff,'k',fitsigmalr,fitepseff,'k:',fitsigma,sfiteff,'k--',fitsigma,ktfiteff,'r',fitsigma,ktmodelfiteff,'r--')
