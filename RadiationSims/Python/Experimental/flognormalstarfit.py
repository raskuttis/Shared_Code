...
for i in xrange(0,nds):
    ...
    for j in xrange(100,5100):
        ...
        print j, pdftime[j], mu, sigma, mum, sigmam
        print j, pdftime[j], h3, h4, h3m, h4m, chisq, chisqm
...
pfid, pall, pmean = plt.plot(plottimes[1],plotmeans[1],'k',plottimes[3],plotmeans[3],'r',plottimes[5],plotmeans[5])
#pfid, pall, pmean = plt.plot(plottimes[0],plotmeans[0],'--k',plottimes[2],plotmeans[2],'--r',plottimes[4],plotmeans[4],'--b')
plt.legend((pfid, pall, pmean), (r"$\displaystyle \Sigma$",r"$\displaystyle \Sigma^{c}_{all}$",r"$\displaystyle \Sigma^{c}_{*}$"))
...
pfid, pall, pmean = plt.plot(plottimes[1],plotsigmas[1],'k',plottimes[3],plotsigmas[3],'r',plottimes[5],plotsigmas[5],'b')
...
pfid, pall, pmean = plt.plot(plottimes[1],ploth3s[1],'k',plottimes[3],ploth3s[3],'r',plottimes[5],ploth3s[5],'b')
...
pfid, pall, pmean = plt.plot(plottimes[1],ploth4s[1],'k',plottimes[3],ploth4s[3],'r',plottimes[5],ploth4s[5],'b')
plt.tick_params(axis='y', which='both', labelleft='off', labelright='on')
