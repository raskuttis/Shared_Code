...
phiratearly = (rad*rcloud)**2 * dphidr / (gravc * (mstar + max(mr)))
...
phirat = (rad*rcloud)**2 * dphidr / (gravc * (mstar + max(mr)))
...
phiratmid = (rad*rcloud)**2 * dphidr / (gravc * (mstar + max(mr)))
...
phiratlate = (rad*rcloud)**2 * dphidr / (gravc * (mstar + max(mr)))
