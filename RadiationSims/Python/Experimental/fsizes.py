...
rdatadir = '/scratch/gpfs/raskutti/RadParGrav/'
...
dflist = ['UV_M5.0e4_R15.0_N256_Tf4_Fluxes/', 'UV_M2.0e4_R15.0_N128_Tf4_Fluxes/', 'UV_M2.0e5_R15.0_N128_Tf4_Fluxes/', 'UV_M5.0e4_R15.0_N256_Tf4_NF_Fluxes/', 'UV_M2.0e4_R15.0_N128_Tf4_NF_Fluxes/', 'UV_M2.0e5_R15.0_N128_Tf4_NF_Fluxes/']
nfs = len(dflist)
nts = 100
...
for i in xrange(0,nfs):
    ...
    datafolder = dflist[i]
    #altdatafolder = altdflist[i]
    outlines = read_outfile(hostname,datadir + datafolder + outfile)
    hstdata = read_hstfile(hostname,datadir + datafolder + hstfile)
    fluxdata = read_fluxfile(rhostname,rdatadir + datafolder + fluxfile)
...
pp = PdfPages(plotdir + 'fsizes.pdf')
pp.savefig()
pp.close()
