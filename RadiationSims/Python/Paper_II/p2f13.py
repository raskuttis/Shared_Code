...
plt.legend((pfid, pall, pmean), (r"$\displaystyle \Sigma$",r"$\displaystyle \Sigma^{c}_{all}$",r"$\displaystyle \Sigma^{c}_{*}$"),prop={'size':8},loc=1)
plt.xscale('log')
plt.yscale('log')
#plt.text(xcap,ycap,r"$\displaystyle(a): \varepsilon(t) = 0.1 \varepsilon_{\rm final}$")
plt.text(xcap,ycap,r"$\displaystyle(a): t_{\rm 10}$")
